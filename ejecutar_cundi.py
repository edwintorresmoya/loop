...
lmatriz_15 = loop_area(nlat_1 = 30, slat_1 = -30, wlon_1 =140, elon_1 =340,# Coordenadas límites de los datos de X
        ...
        variable_y = '/media/edwin/6F71AD994355D30E/Edwin/alexander/preprocesamiento_datos_tr5/base_cpt.csv',
        ...
        eas_lon = -73,# Coordenadas que se van a predecir
        ...
        raster = 'amj_cundi_test',# nombre del archivo de salida
        ...
        spi_lenght = 3, datos_reales = False, iso_lineas = False, missing_val_y = -999.99)
